...
Source0  : https://github.com/numactl/numactl/releases/download/v2.0.14/numactl-2.0.14.tar.gz
...
%prep
%setup -q -n numactl-2.0.14
cd %{_builddir}/numactl-2.0.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600440861
...
cp %{_builddir}/numactl-2.0.14/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/numactl/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/numactl-2.0.14/LICENSE.LGPL2.1 %{buildroot}/usr/share/package-licenses/numactl/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
