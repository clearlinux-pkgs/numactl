...
Version  : 2.0.17
Release  : 26
URL      : https://github.com/numactl/numactl/archive/v2.0.17/numactl-2.0.17.tar.gz
Source0  : https://github.com/numactl/numactl/archive/v2.0.17/numactl-2.0.17.tar.gz
...
%prep
%setup -q -n numactl-2.0.17
cd %{_builddir}/numactl-2.0.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705533128
