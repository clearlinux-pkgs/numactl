...
Version  : 2.0.16
Release  : 24
URL      : https://github.com/numactl/numactl/archive/v2.0.16/numactl-2.0.16.tar.gz
Source0  : https://github.com/numactl/numactl/archive/v2.0.16/numactl-2.0.16.tar.gz
...
%prep
%setup -q -n numactl-2.0.16
cd %{_builddir}/numactl-2.0.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664887441
