...
Version  : 2.0.19
Release  : 30
URL      : https://github.com/numactl/numactl/archive/v2.0.19/numactl-2.0.19.tar.gz
Source0  : https://github.com/numactl/numactl/archive/v2.0.19/numactl-2.0.19.tar.gz
...
%prep
%setup -q -n numactl-2.0.19
cd %{_builddir}/numactl-2.0.19
pushd ..
cp -a numactl-2.0.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729800933
